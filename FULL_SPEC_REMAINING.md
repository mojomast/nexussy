...
Current coverage summary: core Pi worker, MCP tools, web UI, session lifecycle, cost tracking, and worker controls were refreshed in the latest wiring pass. Remaining partial rows are limited to live/external or SPEC/default-renderer decisions.
