...
def artifact_path(kind: str, phase_number: int|None=None) -> str:
    mapping={"interview":".nexussy/artifacts/interview.json","complexity_profile":".nexussy/artifacts/complexity_profile.json","design_draft":".nexussy/artifacts/design_draft.md","validated_design":".nexussy/artifacts/validated_design.md","validation_report":".nexussy/artifacts/validation_report.json","devplan":"devplan.md","devplan_tasks":".nexussy/artifacts/devplan_tasks.json","handoff":"handoff.md","review_report":".nexussy/artifacts/review_report.json","develop_report":".nexussy/artifacts/develop_report.json","merge_report":".nexussy/artifacts/merge_report.json","changed_files":".nexussy/artifacts/changed_files.json","conflict_report":".nexussy/artifacts/conflict_report.json","validate_browser_report":".nexussy/artifacts/validate_browser_report.json"}
