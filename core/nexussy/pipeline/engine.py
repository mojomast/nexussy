...
Engine._STAGE_HANDLERS = {StageName.interview: lambda engine, *a, **kw: interview.run(engine, *a, **kw), StageName.design: lambda engine, *a, **kw: design.run(engine, *a, **kw), StageName.validate: lambda engine, *a, **kw: validate.run(engine, *a, **kw), StageName.plan: lambda engine, *a, **kw: plan.run(engine, *a, **kw), StageName.review: lambda engine, *a, **kw: review.run(engine, *a, **kw), StageName.develop: lambda engine, *a, **kw: develop.run(engine, *a, spawn_fn=spawn_pi_worker, **kw)}
