...
class SteerRequest(StrictModel):
    ...
    def non_empty_public_strings(cls, v):
        ...
        return v
    @model_validator(mode="after")
    def worker_id_required_when_targeting_worker(self):
...
class RoleCapabilityManifest(StrictModel):
    role:WorkerRole; read_files:bool=False; write_files:bool=False; run_bash:bool=False; spawn_subagent:bool=False
