export type StageName = "interview"|"design"|"validate"|"plan"|"review"|"develop"|"validate_browser";
...
export type ArtifactKind = "interview"|"complexity_profile"|"design_draft"|"validated_design"|"validation_report"|"devplan"|"devplan_tasks"|"handoff"|"phase"|"review_report"|"develop_report"|"merge_report"|"conflict_report"|"changed_files"|"validate_browser_report";
...
export interface StageRouting { stage:StageName; primary?:ModelOption; fallback?:ModelOption; profile:RoutingProfileName; notes?:string; workerGroup?:string; explicit?:boolean; }
...
export interface WorkerTaskPayload { worker_id:string; task_id:string; phase_number?:number|null; stage?:StageName|null; task_title:string; status:WorkerTaskStatus; }
...
export interface PausePayload { paused:boolean; reason:string; requested_by?:string; stage?:StageName|null; }
...
export interface PipelineStartRequest { project_name:string; description:string; metadata?:Record<string,JsonValue>; start_stage?:StageName; auto_approve_interview?:boolean; model_overrides?:Partial<Record<StageName,string>>; }
