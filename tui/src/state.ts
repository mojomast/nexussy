...
export function createState(): TuiState { return { stages:Object.fromEntries(STAGES.map(s=>[s,"pending"])) as Record<StageName,StageRunStatus>, workers:{}, locks:[], logs:[], devplan:[], usage:{...zeroUsage}, paused:false, gitEvents:[], blockers:{}, artifacts:[], secrets:[] }; }
